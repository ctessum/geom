...
const (
	PJD_3PARAM    datumType = 1
	PJD_7PARAM    datumType = 2
	PJD_GRIDSHIFT datumType = 3
	PJD_WGS84     datumType = 4 // WGS84 or equivalent
	PJD_NODATUM   datumType = 5 // WGS84 or equivalent
)
const (
